        ...
        for catagory in catagories:
            ...
            for type in ticket_types:
                for type1 in types:
                    ...
                    tariff.type = type1
                    self.response.out.write(catagory + " " + type + " " + type1 + " " + self.request.get(
                        catagory + '_' + type + '_' + type1) + '<br>')
                    tariff.rate = float(self.request.get(catagory + '_' + type + '_' + type1))
                    logging.debug(catagory + " " + type + " ticket " + self.request.get(
                        catagory + '_' + type + '_ticket') + '<br><br>')
