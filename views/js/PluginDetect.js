/*
 ...
 [ Java(OTF) ]
 */
var PluginDetect = {version: "0.7.7", rDate: "04/11/2012", name: "PluginDetect", handler: function (c, b, a) {
    return function () {
        c(b, a)
    }
    ...
    var h, f = this, b = "pd33993399", d = null, j = i ? window.top.document : window.document, c = "<", g = (j.getElementsByTagName("body")[0] || j.body);
    if (!g) {
        try {
    ...
    return f
}, z: 0}, Plugins: {java: {mimeType: ["application/x-java-applet", "application/x-java-vm", "application/x-java-bean"], classID: "clsid:8AD9C840-044E-11D1-B3E9-00805F499D93", navigator: {a: window.navigator.javaEnabled(), javaEnabled: function () {
    return this.a
}, mimeObj: 0, pluginObj: 0}, OTF: null, minIEver: 7, debug: 0, debugEnable: function () {
    var a = this, b = a.$;
    a.debug = 1
}, isDisabled: {$: 1, DTK: function () {
    var a = this, c = a.$, b = a.$$;
...
}, z: 0}, getVerifyTagsDefault: function () {
...
}, DTK: {$: 1, hasRun: 0, status: null, VERSIONS: [], version: "", HTML: null, Plugin2Status: null, classID: "clsid:CAFEEFAC-DEC7-0000-0000-ABCDEFFEDCBA", mimeType: ["application/java-deployment-toolkit", "application/npruntime-scriptable-plugin;DeploymentToolkit"], disabled: function () {
    return this.$$.isDisabled.DTK()
}, query: function () {
    var k = this, g = k.$, d = k.$$, j, l, h, m = {}, f = {}, a, c = null, i = null, b = (k.hasRun || k.disabled());
    k.hasRun = 1;
    if (b) {
        return k
    }
    ...
    ;
    return k
}}, AXO: {$: 1, hasRun: 0, VERSIONS: [], version: "", disabled: function () {
    ...
    return i
}}, navMime: {$: 1, hasRun: 0, mimetype: "", version: "", length: 0, mimeObj: 0, pluginObj: 0, disabled: function () {
    ...
    ;
    return i
}}, navPlugin: {$: 1, hasRun: 0, version: "", disabled: function () {
    return this.$$.isDisabled.navPlugin()
}, query: function () {
    var l = this, d = l.$, c = l.$$, g = c.navigator, i, k, j, f, a, h, e = 0, b = (l.hasRun || l.disabled());
    l.hasRun = 1;
    if (b) {
        return l
    }
    ...
    ;
    return l
}}, lang: {$: 1, System: {$: 1, hasRun: 0, result: [null, null], disabled: function () {
    ...
    var f = this, g = f.$, d = f.$$, i, h = {}, b = (f.hasRun || f.disabled());
    f.hasRun = 1;
    if (!b) {
        var a = "java_qqq990";
        g[a] = null;
    ...
    return[].concat(b)
}, HTML: [0, 0, 0], active: [0, 0, 0], DummyObjTagHTML: 0, DummySpanTagHTML: 0, allowed: [1, 1, 1], VerifyTagsHas: function (c) {
    var d = this, b;
    ...
    var d = this, i = d.$, e = d.$$, l = d.results, p = d.HTML, a = "&nbsp;&nbsp;&nbsp;&nbsp;", g = "A.class", m = i.file.getValid(e);
    if (!m) {
        return d.getResult()
    }
    if (e.OTF < 1) {
